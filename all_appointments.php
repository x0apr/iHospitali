...
<p>Click on the the patient name to fill additional information</p>
...
<table class='table table-striped text-center '>
  <thead class="thead-inverse">
				...
				<th><center>Drugs Given</center></th>
...
<?php
	...
	while($row = $result->fetch_array())
	{
		...
		$link = "<td ><a href= 'drugs.php?appointment_no=" . $row['appointment_no'] . "'>";
		$endingTag = "</a></td>";
		...
		echo "$link" . $row['drugs_given'] . "$endingTag";
